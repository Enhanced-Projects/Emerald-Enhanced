...
u32 FldEff_JumpTallGrass(void)
{
    ...
    LogCoordsCameraRelative((s16 *)&gFieldEffectArguments[0], (s16 *)&gFieldEffectArguments[1], 8, 12);
...
u32 FldEff_Bubbles(void)
{
    ...
    LogCoordsCameraRelative((s16 *)&gFieldEffectArguments[0], (s16 *)&gFieldEffectArguments[1], 8, 0);
...
u32 FldEff_BerryTreeGrowthSparkle(void)
{
    ...
    LogCoordsCameraRelative((s16 *)&gFieldEffectArguments[0], (s16 *)&gFieldEffectArguments[1], 8, 4);
