...
static const u16 sInitialRentalMonRanges[][2] =
{
    ...
    {FRONTIER_MON_DUGTRIO_1,   FRONTIER_MON_REGIGIGAS_1}, // 372 - 467
    {FRONTIER_MON_GLISCOR_1,   FRONTIER_MON_SLAKING_1},   // 468 - 563
    {FRONTIER_MON_DUGTRIO_2,   FRONTIER_MON_REGIGIGAS_2}, // 564 - 659
    {FRONTIER_MON_GLISCOR_2,   FRONTIER_MON_SLAKING_2},   // 660 - 755
    {FRONTIER_MON_DUGTRIO_1,   FRONTIER_MONS_HIGH_TIER},  // 372 - 849

    // Open level
    {FRONTIER_MON_DUGTRIO_1,   FRONTIER_MON_REGIGIGAS_1}, // 372 - 467
    {FRONTIER_MON_GLISCOR_1,   FRONTIER_MON_SLAKING_2},   // 468 - 563
    {FRONTIER_MON_DUGTRIO_2,   FRONTIER_MON_REGIGIGAS_2}, // 564 - 659
    {FRONTIER_MON_GLISCOR_2,   FRONTIER_MON_SLAKING_2},   // 660 - 755
    {FRONTIER_MON_DUGTRIO_1,   FRONTIER_MON_HEATRAN_6},   // 372 - 881
    {FRONTIER_MON_DUGTRIO_1,   FRONTIER_MON_HEATRAN_6},   // 372 - 881
    {FRONTIER_MON_DUGTRIO_1,   FRONTIER_MON_HEATRAN_6},   // 372 - 881
    {FRONTIER_MON_DUGTRIO_1,   FRONTIER_MON_HEATRAN_6},   // 372 - 881
};
