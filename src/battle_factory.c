...
{
    // Level 50
    {FRONTIER_MON_TOXICROAK_3,  FRONTIER_MON_FURRET_1},    // 110 - 199
    {FRONTIER_MON_DELCATTY_1,   FRONTIER_MON_PHIONE_1},    // 162 - 280
    {FRONTIER_MON_DELCATTY_2,   FRONTIER_MON_PHIONE_2},    // 281 - 399
    {FRONTIER_MON_BARBARACLE_1, FRONTIER_MON_REGIGIGAS_1}, // 400 - 499
    {FRONTIER_MON_BRAVIARY_1,   FRONTIER_MON_SLAKING_1},   // 500 - 599
    {FRONTIER_MON_BARBARACLE_2, FRONTIER_MON_REGIGIGAS_2}, // 600 - 699
    {FRONTIER_MON_BRAVIARY_2,   FRONTIER_MON_SLAKING_2},   // 700 - 799
    {FRONTIER_MON_BARBARACLE_1, FRONTIER_MONS_HIGH_TIER},  // 400 - 897
    ...
    {FRONTIER_MON_BARBARACLE_2, FRONTIER_MON_REGIGIGAS_2}, // 600 - 699
    {FRONTIER_MON_BRAVIARY_2,   FRONTIER_MON_SLAKING_2},   // 700 - 799
    {FRONTIER_MON_BARBARACLE_1, FRONTIER_MON_HEATRAN_6},   // 400 - 931
    {FRONTIER_MON_BARBARACLE_1, FRONTIER_MON_HEATRAN_6},   // 400 - 931
    {FRONTIER_MON_BARBARACLE_1, FRONTIER_MON_HEATRAN_6},   // 400 - 931
    {FRONTIER_MON_BARBARACLE_1, FRONTIER_MON_HEATRAN_6},   // 400 - 931
};
...
static void SetPlayerAndOpponentParties(void)
{
    ...
    case 2:
        for (i = 0; i < FRONTIER_PARTY_SIZE; i++)
        {
            ...
            SetMonData(&gEnemyParty[i], MON_DATA_HELD_ITEM, &gFacilityTrainerMons[monId].heldItem);
...
void FillFactoryBrainParty(void)
{
    ...
    {
        u16 monId = GetFactoryMonId(lvlMode, challengeNum, FALSE);
        u8 ability = gFacilityTrainerMons[monId].ability;
        ...
        SetMonData(&gEnemyParty[i], MON_DATA_HELD_ITEM, &gFacilityTrainerMons[monId].heldItem);
        SetMonData(&gEnemyParty[i], MON_DATA_ABILITY_NUM, &gFacilityTrainerMons[monId].ability);
        i++;
    }
}
