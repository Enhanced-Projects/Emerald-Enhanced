    ...
    [FRONTIER_FACILITY_ARENA] =
    {
        ...
        // Gold Symbol.
        {
            ...
            },
            {
                ...
                .evs = {252, 252, 6, 0, 0, 0},
                .ability = 0,
                .moves = {MOVE_DRAIN_PUNCH, MOVE_POISON_JAB, MOVE_KNOCK_OFF, MOVE_MACH_PUNCH},
            },
        },
    },
...
const u16 gFrontierBannedSpecies[] =
{
    ...
    SPECIES_NECROZMA, SPECIES_ARTICUNO, SPECIES_ZAPDOS, SPECIES_MOLTRES, 
    SPECIES_MELOETTA_PIROUETTE, SPECIES_ZERAORA, SPECIES_HEATRAN, 
    SPECIES_GENESECT, SPECIES_HOOPA, SPECIES_HOOPA_UNBOUND, 0xFFFF
};
