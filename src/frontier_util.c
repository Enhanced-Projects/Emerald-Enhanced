...
const u16 gFrontierBannedSpecies[] =
{
    ...
    SPECIES_KYOGRE, SPECIES_GROUDON, SPECIES_RAYQUAZA, SPECIES_HEATRAN,
    SPECIES_MANAPHY, SPECIES_VICTINI, SPECIES_MELOETTA, SPECIES_MELOETTA_PIROUETTE,
    ...
    SPECIES_NAGANADEL, SPECIES_ZERAORA, 0xFFFF
};
