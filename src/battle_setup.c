...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_ANDRES] = REMATCH(TRAINER_ANDRES_1, TRAINER_EMPTY_21, TRAINER_CHALLENGER_SIGMA, TRAINER_CHALLENGER_JUAN, TRAINER_CHALLENGER_GIOVANNI, ROUTE105),
    ...
    [REMATCH_THALIA] = REMATCH(TRAINER_THALIA_1, TRAINER_EMPTY_17, TRAINER_EMPTY_18, TRAINER_EMPTY_19, TRAINER_EMPTY_20, ABANDONED_SHIP_ROOMS_1F),
