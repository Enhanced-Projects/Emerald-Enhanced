...
static const u8 gRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_UNDERWATER_135] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_SNOWSHORE] = MAPPOPUP_THEME_STONE,
    [MAPSEC_CRAGGY_COAST] = MAPPOPUP_THEME_STONE,
    [MAPSEC_FROSTY_FOREST] = MAPPOPUP_THEME_STONE,
    [MAPSEC_FROSTBITE_FIELD] = MAPPOPUP_THEME_STONE,
    [MAPSEC_MT_FREEZE] = MAPPOPUP_THEME_STONE,
