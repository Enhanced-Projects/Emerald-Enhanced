...
static const u8 gRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_ROUTE_66 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_ROUTE_135 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_UNDERWATER,
    ...
    [MAPSEC_UNDERWATER_FROSTY_FOREST - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_UNDERWATER_SNOWY_SHORE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_UNDERWATER,
    ...
    [MAPSEC_UNDERWATER_135 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE2,
    ...
    [MAPSEC_SNOWY_SHORE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_CRAGGY_COAST - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_CRAGGY_COAST_UNDERWATER - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_FROSTY_FOREST - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_FROSTBITE_FIELD - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_MT_FREEZE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_POLAR_PILLAR - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_MIRAGE_CAVE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_LILYCOVE_TRAINING_CENTER - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_BANANA_SLAKOTH_GARDEN - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_FROSTY_GROTTO - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_AETHER_PARADISE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ROUTE_136 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_UNDERWATER
};
