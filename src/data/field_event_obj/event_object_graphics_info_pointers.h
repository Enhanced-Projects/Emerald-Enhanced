...
const struct EventObjectGraphicsInfo *const gEventObjectGraphicsInfoPointers[] = {
    ...
    [EVENT_OBJ_GFX_RIVAL_MAY_MACH_BIKE] =      &gEventObjectGraphicsInfo_RivalMayNormal,
    [EVENT_OBJ_GFX_RIVAL_MAY_ACRO_BIKE] =      &gEventObjectGraphicsInfo_RivalMayNormal,
    [EVENT_OBJ_GFX_RIVAL_MAY_SURFING] =        &gEventObjectGraphicsInfo_RivalMayNormal,
