//@PIDGEY|KAGERU I have NO IDEA what the FUCK is happening here.
...
>>>>>>> rhmaster/master
    ...
    {
        .name = _("Gem Ore(R)"),
        .itemId = ITEM_RARE_GEM_ORE,
        .price = 500,
        .description = sGemOreDesc,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .secondaryId = 0,
    ...
    {
        .name = _("Fossil Ore"),
        .itemId = ITEM_FOSSIL_ORE,
        .price = 600,
        .description = sFossilOreDesc,
        .pocket = POCKET_COLLECTIBLES,
        .type = 4,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .secondaryId = 0,
    ...
    {
        .name = _("Shard Ore"),
        .itemId = ITEM_SHARD_ORE,
        .price = 400,
        .description = sShardOreDesc,
        .pocket = POCKET_COLLECTIBLES,
        .type = 4,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .secondaryId = 0,
...
<<<<<<< HEAD
        .type = 4,
        .fieldUseFunc = ItemUseOutOfBattle_CheckSootSack,
        .secondaryId = 0,
=======
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
...
>>>>>>> rhmaster/master
    ...
    [ITEM_TM51_STEALTH_ROCK] =
    {
        .name = _("TM51"),
        .itemId = ITEM_TM51_STEALTH_ROCK,
        .price = 3000,
    ...
    [ITEM_TM54_SUCKER_PUNCH] =
    {
        .name = _("TM54"),
        .itemId = ITEM_TM54_SUCKER_PUNCH,
        .price = 3000,
    ...
    [ITEM_TM55_DRAGON_PULSE] =
    {
        .name = _("TM55"),
        .itemId = ITEM_TM55_DRAGON_PULSE,
        .price = 3000,
    ...
    [ITEM_TM56_EARTH_POWER] =
    {
        .name = _("TM56"),
        .itemId = ITEM_TM56_EARTH_POWER,
        .price = 3000,
    ...
    [ITEM_TM60_SUPERPOWER] =
    {
        .name = _("TM60"),
        .itemId = ITEM_TM60_SUPERPOWER,
        .price = 3000,
    ...
    [ITEM_TM61_GRAVEL_STORM] =
    {
        .name = _("TM61"),
        .itemId = ITEM_TM61_GRAVEL_STORM,
        .price = 3000,
...
>>>>>>> rhmaster/master
    ...
    [ITEM_MUSCLE_POWDER] =
    {
        .name = _("Muscle Powder"),
        .itemId = ITEM_MUSCLE_POWDER,
        .price = 1000,
        .description = sMusclePowderDesc,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .battleUsage = 2,
    ...
    {
        .name = _("Tough Powder"),
        .itemId = ITEM_TOUGH_POWDER,
        .price = 1000,
        .description = sToughPowderDesc,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .battleUsage = 2,
    ...
    {
        .name = _("Smart Powder"),
        .itemId = ITEM_SMART_POWDER,
        .price = 1000,
        .description = sSmartPowderDesc,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .battleUsage = 2,
    ...
    [ITEM_RESIST_POWDER] =
    {
        .name = _("Resist Powder"),
        .itemId = ITEM_RESIST_POWDER,
        .price = 1000,
        .description = sResistPowderDesc,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .battleUsage = 2,
    ...
    {
        .name = _("Swift Powder"),
        .itemId = ITEM_SWIFT_POWDER,
        .price = 1000,
        .description = sSwiftPowderDesc,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .battleUsage = 2,
    ...
    {
        .name = _("Focus Powder"),
        .itemId = ITEM_FOCUS_POWDER,
        .price = 1000,
        .description = sFocusPowderDesc,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .battleUsage = 2,
    ...
    {
        .name = _("Small Salad"),
        .itemId = ITEM_SMALL_SALAD,
        .price = 1000,
        .description = sSmallSaladDesc,
        .pocket = POCKET_MEDICINE,
        .type = 1,
        .fieldUseFunc = ItemUseOutOfBattle_Medicine,
        .battleUsage = 1,
    ...
    {
        .name = _("Medium Salad"),
        .itemId = ITEM_MEDIUM_SALAD,
        .price = 5000,
        .description = sMediumSaladDesc,
        .pocket = POCKET_MEDICINE,
        .type = 1,
        .fieldUseFunc = ItemUseOutOfBattle_Medicine,
        .battleUsage = 1,
    ...
    {
        .name = _("Large Salad"),
        .itemId = ITEM_LARGE_SALAD,
        .price = 10000,
        .description = sLargeSaladDesc,
        .pocket = POCKET_MEDICINE,
        .type = 1,
        .fieldUseFunc = ItemUseOutOfBattle_Medicine,
        .battleUsage = 1,
    ...
    {
        .name = _("Heal Chowder"),
        .itemId = ITEM_HEAL_CHOWDER,
        .price = 1000,
        .description = sHealChowderDesc,
        .pocket = POCKET_MEDICINE,
        .type = 1,
        .fieldUseFunc = ItemUseOutOfBattle_Medicine,
        .battleUsage = 1,
    ...
    {
        .name = _("Revital Ice"),
        .itemId = ITEM_REVITAL_ICE,
        .price = 5000,
        .description = sRevitalIceDesc,
        .pocket = POCKET_MEDICINE,
        .type = 1,
        .fieldUseFunc = ItemUseOutOfBattle_Medicine,
        .battleUsage = 1,
    ...
    [ITEM_SEASIDE_ALMOND] =
    {
        .name = _("Seaside Almond"),
        .itemId = ITEM_SEASIDE_ALMOND,
        .price = 500,
        .description = sSeasideAlmondDesc,
        .pocket = POCKET_COLLECTIBLES,
        .type = 4,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .secondaryId = 0,
    ...
    [ITEM_SAVANNA_MELON] =
    {
        .name = _("Savanna Melon"),
        .itemId = ITEM_SAVANNA_MELON,
        .price = 500,
        .description = sSavannaMelonDesc,
        .pocket = POCKET_COLLECTIBLES,
        .type = 4,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .secondaryId = 0,
    ...
    {
        .name = _("Deepsea Kelp"),
        .itemId = ITEM_DEEPSEA_KELP,
        .price = 500,
        .description = sDeepseaKelpDesc,
        .pocket = POCKET_COLLECTIBLES,
        .type = 4,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .secondaryId = 0,
    ...
    {
        .name = _("Frost Mint"),
        .itemId = ITEM_FROST_MINT,
        .price = 500,
        .description = sFrostMintDesc,
        .pocket = POCKET_COLLECTIBLES,
        .type = 4,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .secondaryId = 0,
    ...
    [ITEM_CHIMNEY_PEPPER] =
    {
        .name = _("Chimney Pepper"),
        .itemId = ITEM_CHIMNEY_PEPPER,
        .price = 500,
        .description = sChimneyPepperDesc,
        .pocket = POCKET_COLLECTIBLES,
        .type = 4,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .secondaryId = 0,
