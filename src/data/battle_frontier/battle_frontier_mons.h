const struct FacilityMon gBattleFrontierMons[NUM_FRONTIER_MONS] =
{
    ...
    [FRONTIER_MON_CARNIVINE_1] = { // Carnivine-Bulky (ID: 190)
        .species = SPECIES_CARNIVINE,
        .moves = {MOVE_SNAP, MOVE_SLEEP_POWDER, MOVE_PSYCHIC_FANGS, MOVE_SWORDS_DANCE},
        .heldItem = ITEM_LEFTOVERS,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT,
        .ivs = 31,
    ...
    [FRONTIER_MON_CARNIVINE_2] = { // Carnivine-Offensive (ID: 288)
        .species = SPECIES_CARNIVINE,
        .moves = {MOVE_SNAP, MOVE_FIRE_FANG, MOVE_PSYCHIC_FANGS, MOVE_SWORDS_DANCE},
        .heldItem = ITEM_SHELL_BELL,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_ADAMANT,
        .ivs = 31,
