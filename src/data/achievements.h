...
static const struct AtlasAchPointData sAchAtlasData[] =
{
    ...
    [ACH_HEATED_ARGUMENT] = {41, 37, CATEGORY_QUESTING, ACH_HEATED_ARGUMENT, sHeatedArgumentLabel, sHeatedArgumentAchDesc}, // magma main non romance ending
    [ACH_EYE_OF_STORM] = {45, 35, CATEGORY_QUESTING, ACH_EYE_OF_STORM, sEyeOfTheStormLabel, sEyeOfTheStormAchDesc}, // Aqua shelly ending
