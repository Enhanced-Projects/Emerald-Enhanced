...
//quiet waifu
const u8 sLanaQuestStageZeroDesc[] = _("Become champion and find Leaf at the\nSlateport PokeCenter, or her house next door\nto start this quest.");
const u8 sLanaQuestStage2Desc[] = _("player met with Leaf's brother, go to the right\nside of the house and speak to her.");
const u8 sLanaQuestStage4Desc[] = _("player met with Leaf for the first time.\nYou must be champion to continue this quest.\nReturn when you are champion.");
const u8 sLanaQuestStage10Desc[] = _("Leaf took off to the trick house.\nMeet her there.");
const u8 sLanaQuestStage11Desc[] = _("Player entered the trick house.\nWalk forwards to start the event.");
const u8 sLanaQuestStage15Desc[] = _("The first part of Leaf's quest has started.\nYou need to go to and clear out New Mauville.\nLeaf will be at the end.");
const u8 sLanaQuestStage17Desc[] = _("You found Leaf.\nDisable the generator to continue.");
const u8 sLanaQuestStage20Desc[] = _("Leaf has left New Mauville.\nHead to the Abandoned Ship and find the\nscanner to access the Captain's Deck.");
const u8 sLanaQuestStage21Desc[] = _("You found the Scanner, Leaf will now appear in\nthe Captain's Deck of the ship.\nmeet her there.");
const u8 sLanaQuestStage25Desc[] = _("Leaf has left the Abandoned Ship and travelled\nto Pacifidlog Town.\nFind her in a house near the pokemon center.");
const u8 sLanaQuestStage30Desc[] = _("You met Leaf at Pacifidlog Town.\nCapture a wailord and meet Leaf\nin the Sealed Chamber.");
const u8 sLanaQuestStage35Desc[] = _("Leaf will now appear in the Sealed Chamber's\ninner room.\nSpeak to Leaf to continue.\nBe prepared for a hard battle.");
const u8 sLanaQuestStage40Desc[] = _("You have defeated Leaf in the Sealed Chamber.\nAn earthquake will occur, unlocking the three\nRegi chambers for Leaf.");
const u8 sLanaQuestStage45Desc[] = _("The Regi Chambers have been unlocked for Leaf.\nIf you have completed any of these,\nyou will get the alternate line.\nOtherwise, head to the Desert Ruins.");
const u8 sLanaQuestStage55Desc[] = _("Leaf has captured Regirock and left for the\nIsland Cave.\nYou should follow her there.");
const u8 sLanaQuestStage65Desc[] = _("Leaf has captured Regice and has left to travel\nto the Ancient Tomb near Fortree.\nMeet her there.");
const u8 sLanaQuestStage75Desc[] = _("You protected Leaf from Registeel's Rage and\npassed out.\nYou've been teleported home.");
const u8 sLanaQuestStage80Desc[] = _("Leaf has opened up about her history and why\nshe's the way she is.\nYou must return to the Ancient Tomb a\nsecond time. Hard battle incoming.");
const u8 sLanaQuestStage90Desc[] = _("You helped Leaf overcome her past rival.\nHead back to the Trick Master to let\nhim know what you've learned.");
const u8 sLanaQuestStage100Desc[] = _("You have finished Leaf's Quest.\nSpeak with her at her house to finalize\nyour relationship.");
const u8 sLanaQuestStage500Desc[] = _("You triggered Leaf's alternate questline\nbecause you had already done one of the\nRegi Chambers.\nHead to Mt. Pyre's top floor.");
const u8 sLanaQuestStage505Desc[] = _("You found Leaf at Mt. Pyre.\nShe seemed really depressed.\nA Hexer gave you a hint to go to the\nPokemon Day care.");
