...
const u32 gTrainerFrontPic_Dawn[] = INCBIN_U32("graphics/trainers/front_pics/may_front_pic.4bpp.lz");
const u32 gTrainerPalette_Dawn[] = INCBIN_U32("graphics/trainers/palettes/may.gbapal.lz");
