...
const u8 gTrainerBackPic_Dawn[] = INCBIN_U8("graphics/trainers/back_pics/may_back_pic.4bpp");
...
const u32 gTrainerBackPicPal_Dawn[] = INCBIN_U32("graphics/trainers/back_pics/may_back_pic.gbapal.lz");
