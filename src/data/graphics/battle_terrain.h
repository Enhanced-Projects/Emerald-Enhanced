...
const u32 gBattleTerrainTilemap_SnowyShoreMap[] = INCBIN_U32("graphics/battle_terrain/cold/SnowyShoreMap.bin.lz");
const u32 gBattleTerrainPalette_SnowyShorePalette[] = INCBIN_U32("graphics/battle_terrain/cold/SnowyShorePalette.gbapal.lz");
const u32 gBattleTerrainTiles_SnowyShoreTiles[] = INCBIN_U32("graphics/battle_terrain/cold/SnowyShoreTiles.4bpp.lz");
