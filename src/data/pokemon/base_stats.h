...
//@KAGERU With the new battle engine upgrades from master, .Abilities has 3 fields now, and .hiddenAbility was removed.
//Please use your fancy regex magic to append the data from .hiddenAbility to .abilites. I'll show what i mean with Bulbasaur.

//@TOBY With the upgrades, we now have all gen 8 mons and their forms, plus all forms of gen 7 mons. As a result, all species
//after SPECIES_MELMETAL including all forms, megas, etc need to have our balence changes applied. There is still no intent to use gen 8 mons.
...
const struct BaseStats gBaseStats[] =
{
    ...
    [SPECIES_SILVALLY] =
    {
        ...
        .eggGroup1 = EGG_GROUP_UNDISCOVERED,
        .eggGroup2 = EGG_GROUP_UNDISCOVERED,
        .abilities = {ABILITY_RKS_SYSTEM, ABILITY_RKS_SYSTEM},
        .noFlip = FALSE,
        .bodyColor = BODY_COLOR_GRAY,
    },
