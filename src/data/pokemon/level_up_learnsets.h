...
//@TOBY Like the base stats, all mons from grookey and onwards including all forms megas,
//regionals etc need to have their level up set adjusted as you see fit, those are all vanilla.
//I kept our changed for mons UP TO Melmetal
...
static const struct LevelUpMove sCrystalOnixLevelUpLearnset[] = { //@TOBY This needs fixed.
    LEVEL_UP_MOVE( 1, MOVE_HEALING_WISH),
...
static const struct LevelUpMove sToxapexLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_EE_PROTECT),
    LEVEL_UP_MOVE( 1, MOVE_POISON_STING),
    LEVEL_UP_MOVE( 1, MOVE_PECK),
    LEVEL_UP_MOVE( 1, MOVE_BITE),
    LEVEL_UP_MOVE( 1, MOVE_TOXIC_SPIKES),
