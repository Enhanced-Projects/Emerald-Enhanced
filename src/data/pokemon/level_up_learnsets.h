...
static const struct LevelUpMove sVenusaurLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 90, MOVE_GRASS_PLEDGE),
    LEVEL_UP_MOVE(100, MOVE_FRENZY_PLANT),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sCharizardLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 90, MOVE_FIRE_PLEDGE),
...
static const struct LevelUpMove sBlastoiseLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 90, MOVE_WATER_PLEDGE),
    LEVEL_UP_MOVE(100, MOVE_HYDRO_CANNON),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sNinetalesLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(65, MOVE_LAVA_PLUME),
...
static const struct LevelUpMove sGeodudeLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(31, MOVE_GRAVEL_STORM),
...
static const struct LevelUpMove sGolemLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_MUD_SPORT),
    LEVEL_UP_MOVE( 1, MOVE_ROCK_POLISH),
    LEVEL_UP_MOVE( 1, MOVE_GRAVEL_STORM),
    LEVEL_UP_MOVE( 4, MOVE_MUD_SPORT),
    LEVEL_UP_MOVE( 6, MOVE_ROCK_POLISH),
...
static const struct LevelUpMove sMeganiumLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 80, MOVE_PETAL_BLIZZARD),
    LEVEL_UP_MOVE( 90, MOVE_GRASS_PLEDGE),
    LEVEL_UP_MOVE(100, MOVE_FRENZY_PLANT),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sCyndaquilLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(46, MOVE_INFERNO),
    LEVEL_UP_MOVE(49, MOVE_GRAVEL_STORM),
...
static const struct LevelUpMove sQuilavaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(57, MOVE_GRAVEL_STORM),
...
static const struct LevelUpMove sTyphlosionLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 61, MOVE_GRAVEL_STORM),
...
static const struct LevelUpMove sSneaselLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(14, MOVE_ICE_PUNCH),
...
static const struct LevelUpMove sRaikouLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(98, MOVE_ZAP_CANNON),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sEnteiLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(98, MOVE_SACRED_FIRE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSwalotLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(59, MOVE_SLACK_OFF),
...
static const struct LevelUpMove sLileepLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(26, MOVE_GIGA_DRAIN),
    LEVEL_UP_MOVE(28, MOVE_GRAVEL_STORM),
...
static const struct LevelUpMove sJirachiLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(90, MOVE_DOOM_DESIRE),
    LEVEL_UP_MOVE(95, MOVE_METEOR_MASH),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sDusknoirLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(57, MOVE_PAYBACK),
    LEVEL_UP_MOVE(64, MOVE_FUTURE_SIGHT),
    LEVEL_UP_MOVE(69, MOVE_SHADOW_FORCE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sVictiniLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(120, MOVE_V_CREATE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sGreninjaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 73, MOVE_WATER_SHURIKEN),
...
static const struct LevelUpMove sYungoosLevelUpLearnset[] = {//not in EE
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 3, MOVE_LEER),
...
static const struct LevelUpMove sGumshoosLevelUpLearnset[] = {//not in EE
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 1, MOVE_PURSUIT),
    LEVEL_UP_MOVE( 1, MOVE_SAND_ATTACK),
...
static const struct LevelUpMove sBruxishLevelUpLearnset[] = {//not in EE
    LEVEL_UP_MOVE( 1, MOVE_WATER_GUN),
    LEVEL_UP_MOVE( 4, MOVE_ASTONISH),
    LEVEL_UP_MOVE( 9, MOVE_CONFUSION),
...
static const struct LevelUpMove sDrampaLevelUpLearnset[] = {//not in EE
    LEVEL_UP_MOVE( 1, MOVE_PLAY_NICE),
    LEVEL_UP_MOVE( 1, MOVE_ECHOED_VOICE),
...
static const struct LevelUpMove sDhelmiseLevelUpLearnset[] = {//not in EE
    LEVEL_UP_MOVE( 1, MOVE_SWITCHEROO),
    LEVEL_UP_MOVE( 1, MOVE_ABSORB),
    LEVEL_UP_MOVE( 1, MOVE_GROWTH),
    LEVEL_UP_MOVE( 1, MOVE_RAPID_SPIN),
...
static const struct LevelUpMove sTapuKokoLevelUpLearnset[] = {//not in EE
    LEVEL_UP_MOVE( 1, MOVE_ELECTRIC_TERRAIN),
    LEVEL_UP_MOVE( 1, MOVE_BRAVE_BIRD),
    LEVEL_UP_MOVE( 1, MOVE_POWER_SWAP),
    LEVEL_UP_MOVE( 1, MOVE_MEAN_LOOK),
...
static const struct LevelUpMove sTapuLeleLevelUpLearnset[] = {//not in EE
    LEVEL_UP_MOVE( 1, MOVE_PSYCHIC_TERRAIN),
    LEVEL_UP_MOVE( 1, MOVE_AROMATIC_MIST),
    LEVEL_UP_MOVE( 1, MOVE_AROMATHERAPY),
    LEVEL_UP_MOVE( 1, MOVE_MEAN_LOOK),
...
static const struct LevelUpMove sTapuBuluLevelUpLearnset[] = {//not in EE
    LEVEL_UP_MOVE( 1, MOVE_GRASSY_TERRAIN),
    LEVEL_UP_MOVE( 1, MOVE_WOOD_HAMMER),
    LEVEL_UP_MOVE( 1, MOVE_SUPERPOWER),
    LEVEL_UP_MOVE( 1, MOVE_MEAN_LOOK),
...
static const struct LevelUpMove sTapuFiniLevelUpLearnset[] = {//not in EE
    LEVEL_UP_MOVE( 1, MOVE_MISTY_TERRAIN),
    LEVEL_UP_MOVE( 1, MOVE_MOONBLAST),
    LEVEL_UP_MOVE( 1, MOVE_HEAL_PULSE),
    LEVEL_UP_MOVE( 1, MOVE_MEAN_LOOK),
...
static const struct LevelUpMove sCosmogLevelUpLearnset[] = {//not in EE
    LEVEL_UP_MOVE( 1, MOVE_SPLASH),
    LEVEL_UP_MOVE(23, MOVE_TELEPORT),
    LEVEL_UP_END
};

static const struct LevelUpMove sCosmoemLevelUpLearnset[] = {//not in EE
...
static const struct LevelUpMove sSolgaleoLevelUpLearnset[] = {//not in EE
...
static const struct LevelUpMove sLunalaLevelUpLearnset[] = {//not in EE
...
static const struct LevelUpMove sNecrozmaLevelUpLearnset[] = {//not in EE
    LEVEL_UP_MOVE( 1, MOVE_MOONLIGHT),
    LEVEL_UP_MOVE( 1, MOVE_MORNING_SUN),
    LEVEL_UP_MOVE( 1, MOVE_CHARGE_BEAM),
    LEVEL_UP_MOVE( 1, MOVE_MIRROR_SHOT),
...
static const struct LevelUpMove sStakatakaLevelUpLearnset[] = {//not in EE
    LEVEL_UP_MOVE( 1, MOVE_PROTECT),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
...
static const struct LevelUpMove sBlacephalonLevelUpLearnset[] = {//not in EE
    LEVEL_UP_MOVE( 1, MOVE_EMBER),
    LEVEL_UP_MOVE( 1, MOVE_ASTONISH),
...
static const struct LevelUpMove sMeltanLevelUpLearnset[] = {//not in EE
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_END
};

static const struct LevelUpMove sMelmetalLevelUpLearnset[] = {//not in EE
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_END
};

static const struct LevelUpMove sAlolanRattataLevelUpLearnset[] = {//not in EE
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 3, MOVE_TAIL_WHIP),
    LEVEL_UP_MOVE( 6, MOVE_QUICK_ATTACK),
...
static const struct LevelUpMove sAlolanRaticateLevelUpLearnset[] = {//not in EE
    LEVEL_UP_MOVE( 1, MOVE_SWORDS_DANCE),
    LEVEL_UP_MOVE( 1, MOVE_COUNTER),
    LEVEL_UP_MOVE( 1, MOVE_FURY_SWIPES),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
...
static const struct LevelUpMove sAlolanRaichuLevelUpLearnset[] = {//not in EE
    LEVEL_UP_MOVE( 1, MOVE_PSYCHIC),
    LEVEL_UP_MOVE( 1, MOVE_ENCORE),
    LEVEL_UP_MOVE( 1, MOVE_FAKE_OUT),
    LEVEL_UP_MOVE( 1, MOVE_THUNDER_SHOCK),
...
static const struct LevelUpMove sAlolanSandshrewLevelUpLearnset[] = {//not in EE
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
    LEVEL_UP_MOVE( 1, MOVE_DEFENSE_CURL),
...
static const struct LevelUpMove sAlolanSandslashLevelUpLearnset[] = {//not in EE
    LEVEL_UP_MOVE( 1, MOVE_COUNTER),
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
    LEVEL_UP_MOVE( 1, MOVE_DEFENSE_CURL),
    LEVEL_UP_MOVE( 1, MOVE_BIDE),
...
static const struct LevelUpMove sAlolanVulpixLevelUpLearnset[] = {//not in EE
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 3, MOVE_TAIL_WHIP),
...
static const struct LevelUpMove sAlolanNinetalesLevelUpLearnset[] = {//not in EE
    LEVEL_UP_MOVE( 1, MOVE_HYPNOSIS),
    LEVEL_UP_MOVE( 1, MOVE_NASTY_PLOT),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_TAIL_WHIP),
...
static const struct LevelUpMove sAlolanDiglettLevelUpLearnset[] = {//not in EE
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
    LEVEL_UP_MOVE( 4, MOVE_SAND_ATTACK),
    LEVEL_UP_MOVE( 8, MOVE_GROWL),
    LEVEL_UP_MOVE(12, MOVE_AGILITY),
...
static const struct LevelUpMove sAlolanDugtrioLevelUpLearnset[] = {//not in EE
    LEVEL_UP_MOVE( 1, MOVE_TRI_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_SCREECH),
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
    LEVEL_UP_MOVE( 1, MOVE_SAND_ATTACK),
...
static const struct LevelUpMove sAlolanMeowthLevelUpLearnset[] = {//not in EE
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 1, MOVE_BITE),
    LEVEL_UP_MOVE( 1, MOVE_FAKE_OUT),
...
static const struct LevelUpMove sAlolanPersianLevelUpLearnset[] = {//not in EE
    LEVEL_UP_MOVE( 1, MOVE_SWIFT),
    LEVEL_UP_MOVE( 1, MOVE_AMNESIA),
    LEVEL_UP_MOVE( 1, MOVE_HYPNOSIS),
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
...
static const struct LevelUpMove sAlolanGeodudeLevelUpLearnset[] = {//not in EE
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_DEFENSE_CURL),
...
static const struct LevelUpMove sAlolanGravelerLevelUpLearnset[] = {//not in EE
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_DEFENSE_CURL),
    LEVEL_UP_MOVE( 1, MOVE_THUNDER_SHOCK),
    LEVEL_UP_MOVE( 1, MOVE_BIDE),
...
static const struct LevelUpMove sAlolanGolemLevelUpLearnset[] = {//not in EE
...
static const struct LevelUpMove sAlolanGrimerLevelUpLearnset[] = {//not in EE
    LEVEL_UP_MOVE( 1, MOVE_POUND),
    LEVEL_UP_MOVE( 1, MOVE_POISON_GAS),
...
static const struct LevelUpMove sAlolanMukLevelUpLearnset[] = {//not in EE
    LEVEL_UP_MOVE( 1, MOVE_HAZE),
    LEVEL_UP_MOVE( 1, MOVE_MOONBLAST),
    LEVEL_UP_MOVE( 1, MOVE_POUND),
    LEVEL_UP_MOVE( 1, MOVE_POISON_GAS),
...
static const struct LevelUpMove sAlolanExeggutorLevelUpLearnset[] = {//not in EE
    LEVEL_UP_MOVE( 1, MOVE_DRAGON_PULSE),
    LEVEL_UP_MOVE( 1, MOVE_POWER_WHIP),
...
static const struct LevelUpMove sAlolanMarowakLevelUpLearnset[] = {//not in EE
    LEVEL_UP_MOVE( 1, MOVE_SWORDS_DANCE),
    LEVEL_UP_MOVE( 1, MOVE_SCREECH),
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 1, MOVE_TAIL_WHIP),
