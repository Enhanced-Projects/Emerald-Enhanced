...
static const u32 sTutorLearnsets[] =
{
    ...
    [SPECIES_ALOLAN_SANDSHREW] = TUTOR_LEARNSET(TUTOR(MOVE_METRONOME)
											| TUTOR(MOVE_ENDURE)
											| TUTOR(MOVE_ICE_PUNCH)),
    ...
    [SPECIES_ALOLAN_SANDSLASH] = TUTOR_LEARNSET(TUTOR(MOVE_METRONOME)
											| TUTOR(MOVE_ENDURE)
											| TUTOR(MOVE_ICE_PUNCH)),
    ...
    [SPECIES_WOBBUFFET]     = TUTOR_LEARNSET(TUTOR(MOVE_SIGNAL_BEAM)),
    ...
    [SPECIES_LYCANROC_MIDNIGHT]      = TUTOR_LEARNSET(TUTOR(MOVE_METRONOME)
											| TUTOR(MOVE_ZEN_HEADBUTT)
											| TUTOR(MOVE_DRAIN_PUNCH)
											| TUTOR(MOVE_STOMPING_TANTRUM)
											| TUTOR(MOVE_ENDURE)
