...
static const u32 sTutorLearnsets[] =
{
    ...
    [SPECIES_CHIMECHO]      = TUTOR_LEARNSET(TUTOR(MOVE_RECYCLE)
											| TUTOR(MOVE_DOUBLE_EDGE)
											| TUTOR(MOVE_MAGIC_COAT)
											| TUTOR(MOVE_TRICK)
											| TUTOR(MOVE_METRONOME)
    ...
    [SPECIES_BASCULIN]      = TUTOR_LEARNSET(TUTOR(MOVE_BOUNCE)
											| TUTOR(MOVE_DOUBLE_EDGE)
											| TUTOR(MOVE_METRONOME)
											| TUTOR(MOVE_LIQUIDATION)
											| TUTOR(MOVE_ZEN_HEADBUTT)
    ...
    [SPECIES_STUNFISK]      = TUTOR_LEARNSET(TUTOR(MOVE_PAIN_SPLIT)
											| TUTOR(MOVE_BOUNCE)
											| TUTOR(MOVE_METRONOME)
											| TUTOR(MOVE_STOMPING_TANTRUM)
											| TUTOR(MOVE_FOUL_PLAY)
    ...
    [SPECIES_ORANGURU]      = TUTOR_LEARNSET(TUTOR(MOVE_PAIN_SPLIT)
											| TUTOR(MOVE_MAGIC_COAT)
											| TUTOR(MOVE_TRICK)
											| TUTOR(MOVE_METRONOME)
											| TUTOR(MOVE_ZEN_HEADBUTT)
