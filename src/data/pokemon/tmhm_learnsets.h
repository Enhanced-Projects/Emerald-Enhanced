...
const u32 gTMHMLearnsets[][2] =
{
    ...
    [SPECIES_DARMANITAN_ZEN_MODE]  = TMHM_LEARNSET(TMHM(TM45_ATTRACT)
											| TMHM(TM31_BRICK_BREAK)
											| TMHM(TM08_BULK_UP)
											| TMHM(TM04_CALM_MIND)
											| TMHM(TM28_DIG)
    ...
    [SPECIES_DRACOVISH]   = TMHM_LEARNSET(TMHM(TM58_DIVE)
                                            | TMHM(TM26_EARTHQUAKE)
                                            | TMHM(TM42_FACADE)
                                            | TMHM(TM15_HYPER_BEAM)
                                            | TMHM(TM17_PROTECT)
    ...
    [SPECIES_DIGLETT_ALOLAN]  = TMHM_LEARNSET(TMHM(TM51_STEALTH_ROCK)
                                                   | TMHM(TM28_DIG)
                                                   | TMHM(TM26_EARTHQUAKE)
                                                   | TMHM(TM42_FACADE)
                                                   | TMHM(TM17_PROTECT)
    ...
    [SPECIES_DUGTRIO_ALOLAN]  = TMHM_LEARNSET(TMHM(TM51_STEALTH_ROCK)
                                                   | TMHM(TM28_DIG)
                                                   | TMHM(TM26_EARTHQUAKE)
                                                   | TMHM(TM42_FACADE)
                                                   | TMHM(TM15_HYPER_BEAM)
    ...
    [SPECIES_MEOWTH_ALOLAN]  = TMHM_LEARNSET(TMHM(TM51_STEALTH_ROCK)
                                                   | TMHM(TM42_FACADE)
                                                   | TMHM(TM55_DRAGON_PULSE)
                                                   | TMHM(TM23_IRON_TAIL)
                                                   | TMHM(TM17_PROTECT)
    ...
    [SPECIES_PERSIAN_ALOLAN]  = TMHM_LEARNSET(TMHM(TM51_STEALTH_ROCK)
                                                    | TMHM(TM42_FACADE)
                                                    | TMHM(TM55_DRAGON_PULSE)
                                                    | TMHM(TM15_HYPER_BEAM)
                                                    | TMHM(TM23_IRON_TAIL)
