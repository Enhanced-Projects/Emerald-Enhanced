...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_BigSlakothDoll;
...
const struct ObjectEventGraphicsInfo *const gObjectEventGraphicsInfoPointers[NUM_EVENT_OBJ_GFX] = {
    ...
    [OBJ_EVENT_GFX_SLAKOTH_DOLL] =             &gObjectEventGraphicsInfo_BigSlakothDoll,
    ...
    [OBJ_EVENT_GFX_MAY] =              &gObjectEventGraphicsInfo_RubySapphireMay,
