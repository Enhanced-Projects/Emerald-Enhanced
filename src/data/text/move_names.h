const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_PARABOLIC_CHARGE] = _("Focus Charge"),
    ...
    [MOVE_HYPERSPACE_HOLE] = _("Hyper Hole"),
    [MOVE_WATER_SHURIKEN] = _("Water Darts"),
    ...
    [MOVE_PRECIPICE_BLADES] = _("Crag Blade"),
    [MOVE_DRAGON_ASCENT] = _("DragonAscent"),
    [MOVE_HYPERSPACE_FURY] = _("Hyper Fury"),
    [MOVE_SHORE_UP] = _("Shore Up"),
    [MOVE_FIRST_IMPRESSION] = _("Deaigashira"),
    [MOVE_EE_PROTECT] = _("Protect"),
    [MOVE_SPIRIT_SHACKLE] = _("Soul Shackle"),
    [MOVE_DARKEST_LARIAT] = _("Black Lariat"),
    [MOVE_SPARKLING_ARIA] = _("Bubble Aria"),
    ...
    [MOVE_PSYCHIC_TERRAIN] = _("Psy Terrain"),
    [MOVE_LUNGE] = _("Lunge"),
    ...
    [MOVE_REVELATION_DANCE] = _("Divine Dance"),
