...
static const u8 sCRUSH_GRIPDescription[] = _(
    "The target is crushed with\n"
    "great force. Lowers Defense.");
...
const u8 *const gMoveDescriptionPointers[MOVES_COUNT - 1] =
{
    ...
    [MOVE_CRUSH_GRIP - 1] = sCRUSH_GRIPDescription,
