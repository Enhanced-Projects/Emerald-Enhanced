...
static const u8 sSturdyDescription[] = _("Can not be OHKO'd.");
...
static const u8 sObliviousDescription[] = _("Does not fall for taunts.");
...
static const u8 sWonderGuardDescription[] = _("Only takes SE damage.");
...
static const u8 sIlluminateDescription[] = _("Boosts light-based moves.");
...
static const u8 sMagmaArmorDescription[] = _("Blocks Water, boosts Fire.");
...
static const u8 sKeenEyeDescription[] = _("Never misses a move.");
...
static const u8 sHeatproofDescription[] = _("Immune to Fire damage.");
...
static const u8 sWeakArmorDescription[] = _("Becomes nimble when hit.");
...
static const u8 sToxicBoostDescription[] = _("Doubles Attack if poisoned.");
...
static const u8 sIllusionistDescription[] = _("Blocks status moves.");
...
static const u8 sGaleWingsDescription[] = _("Priority Flying at full HP.");
static const u8 sMegaLauncherDescription[] = _("Boosts pulse moves.");
static const u8 sGrassPeltDescription[] = _("Ups defenses in grass.");
...
const u8 gAbilityNames[ABILITIES_COUNT_GEN7][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_ILLUSIONIST] = _("Illusionist"),
    ...
    [ABILITY_PRIMORDIAL_SEA] = _("Primeval Sea"),
    [ABILITY_DESOLATE_LAND] = _("Barren Land"),
    [ABILITY_DELTA_STREAM] = _("Delta Stream"),
    [ABILITY_STAMINA] = _("Stamina"),
    [ABILITY_WIMP_OUT] = _("Wimp Out"),
    [ABILITY_EMERGENCY_EXIT] = _("Fast Escape"),
    [ABILITY_WATER_COMPACTION] = _("Water Pack"),
    ...
    [ABILITY_QUEENLY_MAJESTY] = _("Royalty"),
    ...
    [ABILITY_TANGLING_HAIR] = _("Tangled Hair"),
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT_GEN7] =
{
    ...
    [ABILITY_ILLUSIONIST] = sIllusionistDescription,
