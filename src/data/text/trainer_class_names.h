const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_TRIATHLETE] = _("Athlete"),
    [TRAINER_CLASS_DRAGON_TAMER] = _("Dracophile"),
    [TRAINER_CLASS_NINJA_BOY] = _("Shinobi"),
    [TRAINER_CLASS_BATTLE_GIRL] = _("Tomboy"),
    [TRAINER_CLASS_PARASOL_LADY] = _("Countess"),
    [TRAINER_CLASS_SWIMMER_F] = _("Swimmer♀"),
    [TRAINER_CLASS_TWINS] = _("Twins"),
    [TRAINER_CLASS_SAILOR] = _("Mariner"),
    [TRAINER_CLASS_COOLTRAINER_2] = _("Savant"),
    ...
    [TRAINER_CLASS_AETHER_ADMIN] = _("Aether Admin"),
    [TRAINER_CLASS_AETHER_WORKER] = _("Aether Agent"),
    [TRAINER_CLASS_MOM] = _(""),
};
