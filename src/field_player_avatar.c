...
{
    {OBJ_EVENT_GFX_RIVAL_BRENDAN_NORMAL,     OBJ_EVENT_GFX_RIVAL_DAWN_NORMAL},
    {OBJ_EVENT_GFX_RIVAL_BRENDAN_MACH_BIKE,  OBJ_EVENT_GFX_RIVAL_DAWN_MACH_BIKE},
    {OBJ_EVENT_GFX_RIVAL_BRENDAN_ACRO_BIKE,  OBJ_EVENT_GFX_RIVAL_DAWN_ACRO_BIKE},
    {OBJ_EVENT_GFX_RIVAL_BRENDAN_SURFING,    OBJ_EVENT_GFX_RIVAL_DAWN_SURFING},
    {OBJ_EVENT_GFX_BRENDAN_UNDERWATER,       OBJ_EVENT_GFX_DAWN_UNDERWATER},
    {OBJ_EVENT_GFX_RIVAL_BRENDAN_FIELD_MOVE, OBJ_EVENT_GFX_RIVAL_DAWN_FIELD_MOVE},
    {OBJ_EVENT_GFX_BRENDAN_FISHING,          OBJ_EVENT_GFX_DAWN_FISHING},
    {OBJ_EVENT_GFX_BRENDAN_WATERING,         OBJ_EVENT_GFX_DAWN_WATERING}
};

static const u16 sPlayerAvatarGfxIds[][2] =
{
    {OBJ_EVENT_GFX_BRENDAN_NORMAL,     OBJ_EVENT_GFX_DAWN_NORMAL},
    {OBJ_EVENT_GFX_BRENDAN_MACH_BIKE,  OBJ_EVENT_GFX_DAWN_MACH_BIKE},
    {OBJ_EVENT_GFX_BRENDAN_ACRO_BIKE,  OBJ_EVENT_GFX_DAWN_ACRO_BIKE},
    {OBJ_EVENT_GFX_BRENDAN_SURFING,    OBJ_EVENT_GFX_DAWN_SURFING},
    {OBJ_EVENT_GFX_BRENDAN_UNDERWATER, OBJ_EVENT_GFX_DAWN_UNDERWATER},
    {OBJ_EVENT_GFX_BRENDAN_FIELD_MOVE, OBJ_EVENT_GFX_DAWN_FIELD_MOVE},
    {OBJ_EVENT_GFX_BRENDAN_FISHING,    OBJ_EVENT_GFX_DAWN_FISHING},
    {OBJ_EVENT_GFX_BRENDAN_WATERING,   OBJ_EVENT_GFX_DAWN_WATERING},
};
...
static const u16 sPlayerAvatarGfxToStateFlag[2][5][2] =
{
    ...
    [FEMALE] =
    {
        {OBJ_EVENT_GFX_DAWN_NORMAL, 1},
        {OBJ_EVENT_GFX_DAWN_MACH_BIKE, 2},
        {OBJ_EVENT_GFX_DAWN_ACRO_BIKE, 4},
        {OBJ_EVENT_GFX_DAWN_SURFING, 8},
        {OBJ_EVENT_GFX_DAWN_UNDERWATER, 16},
    }
};
...
{
    gObjectEvents[gPlayerAvatar.objectEventId].playerFollowableMovement = followableMovement;
}

u8 PlayerGetFollowableMovement(void)
{
    return gObjectEvents[gPlayerAvatar.objectEventId].playerFollowableMovement;
}
...
u8 unref_GetRivalAvatarGenderByGraphicsId(u16 gfxId)
{
    ...
    case OBJ_EVENT_GFX_RIVAL_DAWN_MACH_BIKE:
    case OBJ_EVENT_GFX_RIVAL_DAWN_ACRO_BIKE:
    case OBJ_EVENT_GFX_RIVAL_DAWN_SURFING:
    case OBJ_EVENT_GFX_RIVAL_DAWN_FIELD_MOVE:
