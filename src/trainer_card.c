...
static const u16 sHoennTrainerCard1StarDark_Pal[] = INCBIN_U16("graphics/trainer_card/one_stardark.gbapal");
static const u16 sHoennTrainerCard2StarDark_Pal[] = INCBIN_U16("graphics/trainer_card/two_starsdark.gbapal");
static const u16 sHoennTrainerCard3StarDark_Pal[] = INCBIN_U16("graphics/trainer_card/three_starsdark.gbapal");
static const u16 sHoennTrainerCard4StarDark_Pal[] = INCBIN_U16("graphics/trainer_card/four_starsdark.gbapal");
...
static const u16 *const sHoennTrainerCardStarPals[] =
{
    ...
    gHoennTrainerCard0StarDark_Pal,
    sHoennTrainerCard1StarDark_Pal,
    sHoennTrainerCard2StarDark_Pal,
    sHoennTrainerCard3StarDark_Pal,
    sHoennTrainerCard4StarDark_Pal,
};
...
static void SetPlayerCardData(struct TrainerCard *trainerCard, u8 cardType)
{
    ...
    case CARD_TYPE_FRLG:
        ...
        trainerCard->pokeblocksWithFriends = GetCappedGameStat(GAME_STAT_POKEBLOCKS, 0xFFFF);
        if (CountPlayerContestPaintings() > 4)
...
static u8 SetCardBgsAndPals(void)
{
    ...
    case 2:
        if (sData->cardType != CARD_TYPE_FRLG)
        {
            LoadPalette(sHoennTrainerCardStarPals[sData->trainerCard.stars + (VarGet(VAR_RYU_THEME_NUMBER) * 5)], 0, 96);
