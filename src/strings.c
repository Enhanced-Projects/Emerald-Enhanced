...
const u8 gText_BatteryRunDry[] = _("This emulator is incompatible with\nEmerald Enhanced.\pYou need an emulator that supports\nReal Time Clock, or your current\pemulator's implementation of it is\nbroken.");
...
const u8 gText_TurnOff[] = _("Close App");
...
const u8 gText_RyuAbilityChangeDevMenu[] = _("Change Ability");
...
const u8 gText_RyuNewGameMenuEasyMode[] = _("Easy Mode");
const u8 gText_RyuNewGameMenuNormalMode[] = _("Normal Mode");
const u8 gText_RyuNewGameMenuHardMode[] = _("Hard Mode");
const u8 gText_RyuNewGameChallengeMode[] = _("Hard Mode");
...
const u8 gText_RyuRelationshipLanaMenuOption[] = _("Leaf");
