...
const u8 gText_CheckMapOfHoenn[] = _("Check the map of the Hoennregion.");
...
const u8 gText_BattleStyleShift[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Light");
const u8 gText_BattleStyleSet[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Dark");
