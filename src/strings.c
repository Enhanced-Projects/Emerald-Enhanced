...
const u8 gExpandedPlaceholder_Brendan[] = _("{COLOR LIGHT_BLUE}{SHADOW BLUE}Brendan{COLOR DARK_GREY}{SHADOW LIGHT_GREY}");
const u8 gExpandedPlaceholder_May[] = _("{COLOR LIGHT_RED}{SHADOW RED}Dawn{SHADOW LIGHT_GREY}{COLOR DARK_GREY}");
...
const u8 gText_MainMenuContinue[] = _("Resume");
...
const u8 gText_BatteryRunDry[] = _("RTC is not enabled or\nCR2032 Battery is dead.");
...
const u8 gText_BirchBoy[] = _("{COLOR LIGHT_BLUE}{SHADOW BLUE}Male{SHADOW LIGHT_GREY}{COLOR DARK_GREY}");
const u8 gText_BirchGirl[] = _("{COLOR LIGHT_RED}{SHADOW RED}Female{SHADOW LIGHT_GREY}{COLOR DARK_GREY}");
...
const u8 gText_CloseBag[] = _("Exit");
...
const u8 gUnknown_085E933F[] = _("Texture");
...
const u8 gUnknown_085E96BE[] = _("Attacks");
...
const u8 gText_NextLv[] = _("to next ");
...
const u8 gText_BattleMoves[] = _("Attacks");
const u8 gText_ContestMoves[] = _("Contest Moves");
const u8 gText_Info[] = _("Info");
const u8 gText_EggWillTakeVeryLong[] = _("The egg is very fresh.");
const u8 gText_EggWillTakeALongTime[] = _("It looks like this egg will\ntake a long time to hatch.");
const u8 gText_EggWillTakeSomeTime[] = _("The egg seems like\nit needs to mature more.");
...
const u8 gText_NoRegistry[] = _("Nothing's registered.");
const u8 gText_DelRegist[] = _("Unregister");
const u8 gUnknown_085EA7A9[] = _("{STR_VAR_3}{STR_VAR_1}/{STR_VAR_2}");
const u8 gText_Decorate[] = _("Decorate");
const u8 gText_PutAway[] = _("Stow");
const u8 gText_Toss2[] = _("Trash");
...
const u8 gPCText_Cancel[] = _("Abort");
...
const u8 gPCText_Wallpaper[] = _("Background");
...
const u8 gPCText_Scenery1[] = _("Scene Pack 1");
const u8 gPCText_Scenery2[] = _("Scene Pack 2");
const u8 gPCText_Scenery3[] = _("Scene Pack 3");
...
const u8 gPCText_Simple[] = _("Blank");
...
const u8 gUnknown_085EBE7D[] = _("Details");
...
const u8 gText_DynColor2Male[] = _("{COLOR DYNAMIC_COLOR1}♀");
const u8 gText_DynColor1Female[] = _("{COLOR DYNAMIC_COLOR2}♂");
...
const u8 gText_BattleStyle[] = _("Battle Swap");
...
const u8 gText_BattleStyleShift[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Ask");
const u8 gText_BattleStyleSet[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Don't Ask");
