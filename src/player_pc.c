...
static void PlayerPC_TurnOff(u8 taskId)
{
    if (sTopMenuNumOptions == 4) // if the option count is 4, we are at the bedroom PC, so do gender specific handling.
        ScriptContext1_SetupScript(RyuScript_TurnOffPlayerPc);
    else
