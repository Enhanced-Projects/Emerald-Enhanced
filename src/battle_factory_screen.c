...
static void CreateFrontierFactorySelectableMons(u8 firstMonId)
{
    ...
    for (i = 0; i < SELECTABLE_MONS_COUNT; i++)
    {
        ...
        SetMonData(&sFactorySelectScreen->mons[i + firstMonId].monData, MON_DATA_HELD_ITEM, &gFacilityTrainerMons[monId].heldItem);
        SetMonData(&sFactorySelectScreen->mons[i + firstMonId].monData, MON_DATA_ABILITY_NUM, &gFacilityTrainerMons[monId].ability);
        SetMonData(&sFactorySelectScreen->mons[i + firstMonId].monData, MON_DATA_HP_IV, &gFacilityTrainerMons[monId].ivs);
        SetMonData(&sFactorySelectScreen->mons[i + firstMonId].monData, MON_DATA_ATK_IV, &gFacilityTrainerMons[monId].ivs);
        SetMonData(&sFactorySelectScreen->mons[i + firstMonId].monData, MON_DATA_DEF_IV, &gFacilityTrainerMons[monId].ivs);
        SetMonData(&sFactorySelectScreen->mons[i + firstMonId].monData, MON_DATA_SPATK_IV, &gFacilityTrainerMons[monId].ivs);
        SetMonData(&sFactorySelectScreen->mons[i + firstMonId].monData, MON_DATA_SPDEF_IV, &gFacilityTrainerMons[monId].ivs);
        SetMonData(&sFactorySelectScreen->mons[i + firstMonId].monData, MON_DATA_SPEED_IV, &gFacilityTrainerMons[monId].ivs);
    }
}
