...
static const u8 sText_DebugUtilityItem5[] = _("Change Difficulty");
...
static const u8 sFollowerGladion[] = _("Spawn Gladion");
static const u8 sFollowerLillie[] = _("Spawn Lillie");
