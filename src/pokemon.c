...
static const struct SpriteTemplate gSpriteTemplateTable_TrainerBackSprites[] =
{
    ...
    },
    {
        ...
        .oam = &gOamData_831ACB0,
        .anims = NULL,
        .images = gTrainerBackPicTable_Lucy,
        .affineAnims = gUnknown_082FF618,
        .callback = sub_8039BB4,
    },
    {
    ...
    },
    {
        ...
        .oam = &gOamData_831ACB0,
        .anims = NULL,
        .images = gTrainerBackPicTable_Gladion,
        .affineAnims = gUnknown_082FF618,
        .callback = sub_8039BB4,
    },
    {
...
void CreateMonWithNature(struct Pokemon *mon, u16 species, u8 level, u8 fixedIV, u8 nature)
{
    ...
    if (FlagGet(FLAG_RYU_FORCE_EVENT_OTID) == TRUE)
        CreateMon(mon, species, level, fixedIV, 1, personality, OT_ID_PRESET, 42069);
    else
