...
static const u8 sText_PkmnMakesGroundMiss[] = _("{B_DEF_NAME_WITH_PREFIX} is immune because\nof its {B_DEF_ABILITY}!");
static const u8 sText_PkmnAvoidedAttack[] = _("{B_DEF_NAME_WITH_PREFIX} avoided\nthe attack!");
static const u8 sText_ItDoesntAffect[] = _("It doesn't affect\n{B_DEF_NAME_WITH_PREFIX}…");
static const u8 sText_AttackerFainted[] = _("{B_ATK_NAME_WITH_PREFIX}\nfainted!\p");
static const u8 sText_TargetFainted[] = _("{B_DEF_NAME_WITH_PREFIX}\nfell unconscious!\p");
static const u8 sText_TargetFainted2x[] = _("{B_DEF_NAME_WITH_PREFIX}\nwas rekt!\p");
static const u8 sText_TargetFainted4x[] = _("{B_DEF_NAME_WITH_PREFIX}\nwas obliterated!\p");
static const u8 sText_TargetFainted10x[] = _("{B_DEF_NAME_WITH_PREFIX} has departed from\nthis realm...\p");
static const u8 sText_TargetFainted20x[] = _("{B_DEF_NAME_WITH_PREFIX}'s spirit was scattered\nto the ether...\p");
static const u8 sText_PlayerGotMoney[] = _("{B_PLAYER_NAME} got ¥{B_BUFF1}\nfor winning!\p");
static const u8 sText_PlayerWhiteout[] = _("{B_PLAYER_NAME} is out of\nusable Pokémon!\p");
static const u8 sText_PlayerWhiteout2[] = _("{B_PLAYER_NAME} passed out!{PAUSE_UNTIL_PRESS}");
...
static const u8 sText_EnemyAboutToSwitchPkmn[] = _("Will {B_PLAYER_NAME} change\nPokémon?");
...
static const u8 sText_LeadersWantToBattle[] = _("Leaders {B_TRAINER1_NAME}\nwould like to battle!\p");
...
static const u8 sText_Cling[] = _("{B_DEF_NAME_WITH_PREFIX} is being hugged\nby {B_ATK_NAME_WITH_PREFIX}!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_TARGETFAINTED2X - 12] = sText_TargetFainted2x,
    [STRINGID_TARGETFAINTED4X - 12] = sText_TargetFainted4x,
    [STRINGID_TARGETFAINTED10X - 12] = sText_TargetFainted10x,
    [STRINGID_TARGETFAINTED20X - 12] = sText_TargetFainted20x,
    ...
    [STRINGID_ITDEALTDAMAGE - 12] = sText_RyuItDealtDamage,
    [STRINGID_ITDEALTOVERKILLDAMAGE - 12] = sText_RyuItDealtOverkillDamage,
    [STRINGID_ITDEALTDAMAGECRIT - 12] = sText_RyuItDealtDamageCrit,
    [STRINGID_ITDEALTOVERKILLDAMAGECRIT - 12] = sText_RyuItDealtOverkillDamageCrit,
    [STRINGID_ITDEALTSEDAMAGE - 12] = sText_RyuItDealtSEDamage,
    [STRINGID_ITDEALTSEOVERKILLDAMAGE - 12] = sText_RyuItDealtSEOverkillDamage,
    [STRINGID_ITDEALTNVEDAMAGE - 12] = sText_RyuItDealtNVEDamage,
    [STRINGID_ITDEALTNVEOVERKILLDAMAGE - 12] = sText_RyuItDealtNVEOverkillDamage,
...
const u16 gWeatherStartsStringIds[] =
{
    ...
    [WEATHER_SNOW]               = STRINGID_HAILISBREWING,
...
const u8 gText_WhatWillPkmnDo[] = _("What will {B_PLAYER_NAME}\n do?  {COLOR LIGHT_GREEN}{SHADOW GREEN}({SELECT_BUTTON}: Info)");
const u8 gText_WhatWillPkmnDo2[] = _("What will\n{B_PLAYER_NAME} do?");
const u8 gText_WhatWillWallyDo[] = _("What will\nWALLY do?");
const u8 gText_LinkStandby[] = _("{PAUSE 16}Link standby…");
const u8 gText_BattleMenu[] = _("Use Move{CLEAR_TO 56}Pack\nPokémon{CLEAR_TO 56}Run");
...
const u8 gText_Sleep[] = _("Sleeping");
const u8 gText_Poison[] = _("Poisoned");
const u8 gText_Burn[] = _("Burned");
const u8 gText_Paralysis[] = _("Paralyzed");
const u8 gText_Ice[] = _("ice");
const u8 gText_Confusion[] = _("Confused");
