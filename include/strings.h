...
extern const u8 gText_MenuJournal[];
...
extern const u8 gText_Var1CantBeHeld2[];
...
extern const u8 gText_RightTutorOutrage[];
...
// Battle Frontier Move Tutors
extern const u8 BattleFrontier_Lounge7_Text_Liquidation[];
extern const u8 BattleFrontier_Lounge7_Text_SeismicTossDesc[];
extern const u8 BattleFrontier_Lounge7_Text_ZenHeadbutt[];
extern const u8 BattleFrontier_Lounge7_Text_PainSplit[];
extern const u8 BattleFrontier_Lounge7_Text_Recycle[];
extern const u8 BattleFrontier_Lounge7_Text_BodySlamDesc[];
extern const u8 BattleFrontier_Lounge7_Text_LowKick[];
extern const u8 BattleFrontier_Lounge7_Text_MagicCoat[];
...
extern const u8 BattleFrontier_Lounge7_Text_FoulPlay[];
...
extern const u8 gText_DarkShard[];
extern const u8 gText_LightShard[];
extern const u8 gText_CyanShard[];
extern const u8 gText_GlossyShard[];
extern const u8 gText_GoldShard[];
...
extern const u8 gText_PLUME_FOSSIL[];
extern const u8 gText_JAW_FOSSIL[];
extern const u8 gText_SAIL_FOSSIL[];
...
extern const u8 gText_MatchCallDawn_Strategy[];
extern const u8 gText_MatchCallDawn_Pokemon[];
extern const u8 gText_MatchCallDawn_Intro1[];
extern const u8 gText_MatchCallDawn_Intro2[];
...
extern const u8 gText_CheckAchievements[];
...
extern const u8 gText_RyuRelationshipNurseMenuOption[];
...
extern const u8 gText_RyuBetaMenuResetRTC[];
