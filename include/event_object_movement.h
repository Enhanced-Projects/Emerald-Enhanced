...
#define GROUND_EFFECT_FLAG_SAFARI_TALL_GRASS_ON_SPAWN (1 << 20)
#define GROUND_EFFECT_FLAG_SAFARI_TALL_GRASS_ON_MOVE  (1 << 21)
...
bool8 FollowPlayerMovement_None(struct ObjectEvent *, struct Sprite *, u8);
bool8 FollowPlayerMovement_GoSpeed0(struct ObjectEvent *, struct Sprite *, u8);
bool8 FollowPlayerMovement_GoSpeed1(struct ObjectEvent *, struct Sprite *, u8);
bool8 FollowPlayerMovement_GoSpeed2(struct ObjectEvent *, struct Sprite *, u8);
bool8 FollowPlayerMovement_JumpLedge(struct ObjectEvent *, struct Sprite *, u8);
bool8 FollowPlayerMovement_CrossLedge(struct ObjectEvent *, struct Sprite *, int);
