...
#define MOVE_RESULT_ULTRA_EFFECTIVE    (1 << 10)
...
#define WEATHER_ECLIPSE_TEMPORARY   (1 << 11)
#define WEATHER_ECLIPSE_PERMANENT   (1 << 12)
#define WEATHER_ECLIPSE_ANY         (WEATHER_ECLIPSE_TEMPORARY | WEATHER_ECLIPSE_PERMANENT)
#define WEATHER_STRONG_WINDS        (1 << 13)
#define WEATHER_ANY                 (WEATHER_RAIN_ANY | WEATHER_SANDSTORM_ANY | WEATHER_SUN_ANY | WEATHER_HAIL_ANY | WEATHER_ECLIPSE_ANY)
