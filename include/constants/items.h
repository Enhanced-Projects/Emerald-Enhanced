...
//custom items go here from now on
#define ITEM_TONIC_WATER 1000
#define ITEM_MINERAL_WATER 1001
#define ITEM_GOLD_NUGGET 1002
#define ITEM_GEM_POWDER 1003
#define CUSTOM_ITEMS_COUNT 4

#define ITEMS_COUNT (ITEM_ULTRANECROZIUM_Z + CUSTOM_ITEMS_COUNT)
