...
#define B_SPEED_BUFFING_RAPID_SPIN  GEN_8 // In Gen8+ Rapid Spin boosts speed by 1 stage.

// Ability settings
#define B_ABILITY_POP_UP            GEN_7 // In Gen5+, the Pokémon abilities are displayed in a pop-up, when they activate in battle.
...
// Other
#define B_FLAG_INVERSE_BATTLE       0     // Do not use this flag. I have an alternate system in place.
