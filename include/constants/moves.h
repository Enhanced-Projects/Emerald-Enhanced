...
#define MOVE_SNUGGLE 1000
#define MOVE_CLING 1001
#define CUSTOM_MOVES_COUNT 2

#define MOVES_COUNT_GEN8 755

#define MOVES_COUNT (MOVES_COUNT_GEN8 + CUSTOM_MOVES_COUNT)
