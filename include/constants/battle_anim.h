...
#define B_ANIM_FORM_CHANGE              0x1C
#define B_ANIM_SLIDE_OFFSCREEN          0x1D // for Emergency Exit
#define B_ANIM_RYU_AFFECTION_ANIM       0x1E
#define B_ANIM_ECLIPSE                  0x1F
#define B_ANIM_STRONG_WINDS             0x20
